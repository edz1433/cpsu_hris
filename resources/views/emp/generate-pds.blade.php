        ...
        <table class="table table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="bordered pl2" colspan="2">{{ $datas['employee']->item_no }}</th>
        ...
        <table class="table table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[0]) ? \Carbon\Carbon::parse(trim($children_bday[0]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    <td class="pl1 bg2">&nbsp;&nbsp;MIDDLE NAME</td>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[1]) ? \Carbon\Carbon::parse(trim($children_bday[1]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[2]) ? \Carbon\Carbon::parse(trim($children_bday[2]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[3]) ? \Carbon\Carbon::parse(trim($children_bday[3]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[4]) ? \Carbon\Carbon::parse(trim($children_bday[4]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[5]) ? \Carbon\Carbon::parse(trim($children_bday[5]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th colspan="2" class="bordered pl1 tl">{{ isset($children_bday[6]) ? \Carbon\Carbon::parse(trim($children_bday[6]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    <td class="pl1 bg2">&nbsp;&nbsp;FIRST NAME</td>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[7]) ? \Carbon\Carbon::parse(trim($children_bday[7]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    <td class="pl1 bg2">&nbsp;&nbsp;MIDDLE NAME</td>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[8]) ? \Carbon\Carbon::parse(trim($children_bday[8]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th colspan="2" class="bordered pl1 tl">{{ isset($children_bday[9]) ? \Carbon\Carbon::parse(trim($children_bday[9]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[10]) ? \Carbon\Carbon::parse(trim($children_bday[10]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
                    <td class="pl1 bg2">&nbsp;&nbsp;FIRST NAME</td>
                    ...
                    <th class="bordered" colspan="2">{{ isset($children_bday[11]) ? \Carbon\Carbon::parse(trim($children_bday[11]))->format('m/d/Y') : ''; }}</th>
                </tr>
                <tr>
        ...
        <table class="table table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="bordered vcenter">{{ strtoupper($datas['educBg']->coll_school) }}</th>
                    <th class="bordered vcenter" colspan="2">{{ strtoupper($datas['educBg']->coll_course) }}</th>
                    <th class="bordered vcenter">{{ isset(explode('-', $datas['educBg']->coll_period)[0]) ? strtoupper(explode('-', $datas['educBg']->coll_period)[0]) : '' }}</th>
                    <th class="bordered vcenter">{{ isset(explode('-', $datas['educBg']->coll_period)[1]) ? strtoupper(explode('-', $datas['educBg']->coll_period)[1]) : '' }}</th>
                    <th class="bordered vcenter">{{ strtoupper($datas['educBg']->coll_level) }}</th>
                    <th class="bordered vcenter">{{ isset(explode('-', $datas['educBg']->coll_grad)[0]) ? strtoupper(explode('-', $datas['educBg']->coll_grad)[0]) : '' }}</th>
                    <th class="bordered vcenter">{{ strtoupper($datas['educBg']->coll_honor) }}</th>
                </tr>
                <tr>
    ...
    <div class="div">
        <table class="table table2">
            ...
            <tbody>
                ...
                @php $learning = 18 - count($datas['learningdev']); @endphp
                ...
                <tr>
                    ...
                    <td class="bordered h-1" width="35%">
                        <div style="float: left; margin-top: 31px;">
                            ...
                            <div style="margin-left: 5px; margin-top: {{ ($otherinfo_question[1] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[1]) && $otherinfo_question[1] == 1) ? $otherinfo_questiondetail[1] : ''}}</div>
                        </div>
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; margin-top: {{ ($otherinfo_question[2] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[2]) && $otherinfo_question[2] == 1) ? $otherinfo_questiondetail[2] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; margin-top: {{ ($otherinfo_question[4] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[4]) && $otherinfo_question[4] == 1) ? $otherinfo_questiondetail[4] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; margin-top: {{ ($otherinfo_question[5] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[5]) && $otherinfo_question[5] == 1) ? $otherinfo_questiondetail[5] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
