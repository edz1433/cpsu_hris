        ...
        <table class="table table1" style="margin-top: -10px !important;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="bordered pl2" colspan="2">{{ $datas['employee']->agency_no }}</th>
                ...
                <tr>
                    ...
                    <td class="bordered h-1" width="35%">
                        <div style="float: left; margin-top: 31px;">
                            ...
                            <div style="margin-left: 5px; font-size: 12px; margin-top: {{ ($otherinfo_question[1] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[1]) && $otherinfo_question[1] == 1) ? $otherinfo_questiondetail[1] : ''}}</div>
                        </div>
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; font-size: 12px; margin-top: {{ ($otherinfo_question[2] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[2]) && $otherinfo_question[2] == 1) ? $otherinfo_questiondetail[2] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; font-size: 12px; margin-top: {{ ($otherinfo_question[4] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[4]) && $otherinfo_question[4] == 1) ? $otherinfo_questiondetail[4] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
                ...
                <tr>
                    ...
                    <td class="bordered h-2" width="35%">
                        <div style="float: left;">
                            ...
                            <div style="margin-left: 5px; margin-top: 5px;">If YES, give details:</div>
                            <div style="margin-left: 5px; font-size: 12px; margin-top: {{ ($otherinfo_question[5] == 1) ? '5px;' : '17px;'}} width: 238px; display: inline-block; border-bottom: 1px solid black;">{{ (isset($otherinfo_question[5]) && $otherinfo_question[5] == 1) ? $otherinfo_questiondetail[5] : ''}}</div>
                        </div>
                        <div style="float: right; margin-right: 17px;">
