...
<table id="table-form">
    ...
    <tbody id="tbody-form">
        <tr>
            ...
            <td class="b-none text-center"> <i class="fas fa-plus fa-lg text-success1 pl-1" data-toggle="modal" data-cat="1" data-id="{{ $prs[0]->id }}" data-mfo="{{ $prs[0]->mfo ?? '' }}" data-percent="{{ $prs[0]->percent ?? '' }}"  data-target="#createOpcrMfoModal"></td>
        </tr>
        ...
        <tr>
            ...
            @php $filteredOpcrMfoDatas = $opcrmfodatas->where('opcr_mfo_id', $core->id); @endphp
        ...
        <tr>
            ...
            <td></td>
            <td class="text-center"><span class="badge badge-danger rounded-circle">X</span></td>
            <td class="b-none text-center"> <i class="fas fa-plus fa-lg text-success1 pl-1" data-toggle="modal" data-cat="2" data-id="{{ $prs[1]->id }}" data-mfo="{{ $prs[1]->mfo ?? '' }}" data-percent="{{ $prs[1]->percent ?? '' }}" data-target="#createOpcrMfoModal"></td>
        </tr>
        ...
        <tr>
            ...
            @php $opcrmfodatas = $opcrmfodatas->where('opcr_mfo_id', $strat->id); @endphp
            @foreach($opcrmfodatas as $opcrmfodata)
                <tr>
                    <td class="text-left align-top">{{ $opcrmfodata->mfo }}</td>
                    <td class="text-left pl-1">{{ $opcrmfodata->target }}</td>
                    <td class="text-center"></td>
        ...
        <tr>
            ...
            <td></td>
            <td class="text-center"><span class="badge badge-danger rounded-circle">X</span></td>
            <td class="b-none text-center"> <i class="fas fa-plus fa-lg text-success1 pl-1" data-toggle="modal" data-cat="3" data-id="{{ $prs[2]->id }}" data-mfo="{{ $prs[2]->mfo ?? '' }}" data-percent="{{ $prs[2]->percent ?? '' }}" data-target="#createOpcrMfoModal"></td>
        </tr>
        ...
        <tr>
            ...
            @php $opcrmfodatas = $opcrmfodatas->where('opcr_mfo_id', $supp->id); @endphp
            @foreach($opcrmfodatas as $opcrmfodata)
                <tr>
                    <td class="text-left align-top">{{ $opcrmfodata->mfo }}</td>
                    <td class="text-left pl-1">{{ $opcrmfodata->target }}</td>
