                    ...
                    <div class="form-group mtop">
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="1" name="leave_type" id="vacation-leave" required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="2" name="leave_type" required>
                                    <label class="form-check-label" for="radio2">
                                        <b>Mandatory/Forced Leave</b> <span class="ft">(Sec. 51, Rule XVI, Omnibus Rules Implementing E.O No. 292)</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="3" name="leave_type" id="sick-leave" required>
