                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                ...
                                <input type="hidden" name="empid" value="{{ $employee->id }}">
                                <input class="form-control form-control-sm" type="text" id="sl" name="sl" step="0.001" min="0" max="30" placeholder="0.00" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                ...
                                <input class="form-control form-control-sm" type="number" id="vl" name="vl" step="0.001" min="0" max="30" placeholder="0.00" required readonly>
                            </div>
                        </div>
                ...
                <form class="form-horizontal" action="{{ route('leavesUpdate') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <label class="badge badge-secondary">Vacation Leave</label>
                                <input class="form-control form-control-sm" type="number" id="vl1" name="vl" step="0.001" min="0" max="30" placeholder="0.00" required readonly>
                            </div>
                        </div>
