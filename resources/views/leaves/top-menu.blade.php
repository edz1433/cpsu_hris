...
<div class="row">
    <div class="col-md-4">
        <a href="{{ $leaveCreditsRoute }}" class="nav-link {{ $isLeaveCreditsActive ? 'bg-default' : 'bg-secondary' }}" style="border-radius: 5px;">
    ...
    <div class="col-md-4">
        <a href="{{ $statusRoute }}" class="nav-link {{ $isStatusActive ? 'bg-default' : 'bg-secondary' }}" style="border-radius: 5px;">
    ...
    <div class="col-md-4">
        <a href="{{ $historyRoute }}" class="nav-link bg-secondary" style="border-radius: 5px;">
